const translations = {
  ca: {
    ...
    "hero.eyebrow": "Desenvolupador d'aplicacions multiplataforma",
    "hero.lead": "Creo aplicacions i solucions web amb codi net, atenció al detall i ganes constants d'aprendre.",
    "hero.ctaProjects": "Veure projectes",
    "hero.ctaContact": "Contacta'm",
    "hero.statHours": "hores de pràctiques",
    "hero.statDegrees": "titulacions i estudis",
    ...
    "about.langTitle": "Idiomes",
    "about.langCa": "Català",
    "about.langEs": "Castellà",
    "about.langEn": "Anglès",
    "about.levelNative": "Natiu",
    "about.levelInter": "Intermedi",
    "exp.title": "Experiència",
    "exp.job1Role": "Programador Júnior",
    "exp.job1Date": "Juliol 2026 - Actualitat",
    "exp.job1Org": "Hospital General de Granollers",
    "exp.job1b1": "Desenvolupament i creació des de zero d'un nou sistema informàtic integral per a la gestió de personal.",
    "exp.job1b2": "Disseny de mòduls per al control d'horaris, torns de treball, permisos i expedients d'empleats.",
    "exp.job1b3": "Integració amb bases de dades i digitalització dels fluxos de treball del departament de RRHH.",
    "exp.job1b4": "Anàlisi de requisits i suport continu als usuaris de la plataforma.",
    "exp.job2Role": "Pràctiques de desenvolupament · CFGS DAM",
    "exp.job2Date": "Octubre 2025 - Maig 2026 · 515 h",
    "exp.job2Org": "Iswolk Technology — Consultoria informàtica (conveni Tecnocampus)",
    "exp.job2b1": "Desenvolupament i integració d'APIs.",
    "exp.job2b2": "Gestió i administració de cursos i plataformes.",
    "exp.job2b3": "Atenció i seguiment de clients en un entorn professional real.",
    "exp.job3Role": "Pràctiques de sistemes i xarxes · CFGM SMX",
    "exp.job3Date": "Juny 2023 - Març 2024 · 400 h",
    "exp.job3Org": "Escola Universitària d'Hoteleria i Turisme — Gran Sol",
    "exp.job3b1": "Manteniment i configuració de sistemes i equips informàtics.",
    "exp.job3b2": "Configuració i administració de xarxes.",
    "exp.job3b3": "Resolució d'incidències tècniques i suport a l'usuari.",
    "exp.job3b4": "Treball en equip en un entorn laboral real.",
    "edu.title": "Estudis",
    "edu.badgeUni": "Grau universitari",
    "edu.badgeHigher": "Grau superior",
    "edu.badgeMid": "Grau mitjà",
    "edu.deg0": "Grau d'Enginyeria Informàtica de Gestió i Sistemes d'Informació",
    "edu.deg0Date": "Setembre 2026 - Present",
    "edu.deg1": "CFGS Desenvolupament d'Aplicacions Multiplataforma",
    "edu.deg1Date": "Setembre 2024 - Juny 2026",
    "edu.deg2": "CFGM Sistemes Microinformàtics i Xarxes",
    "edu.deg2Date": "Setembre 2022 - Juny 2024",
    ...
    "projects.sub": "Projectes públics del meu perfil de GitHub.",
    "projects.loading": "Carregant projectes…",
    "projects.viewAll": "Veure tot a GitHub",
    "projects.empty": "Aviat hi haurà projectes públics aquí.",
    ...
    "footer.built": "Fet amb HTML, CSS i JavaScript"
  },
  es: {
    "nav.about": "Sobre mí",
    ...
    "hero.eyebrow": "Desarrollador de aplicaciones multiplataforma",
    "hero.lead": "Creo aplicaciones y soluciones web con código limpio, atención al detalle y ganas constantes de aprender.",
    "hero.ctaProjects": "Ver proyectos",
    "hero.ctaContact": "Contáctame",
    "hero.statHours": "horas de prácticas",
    "hero.statDegrees": "titulaciones y estudios",
    ...
    "about.langEs": "Castellano",
    "about.langEn": "Inglés",
    "about.levelNative": "Nativo",
    "about.levelInter": "Intermedio",
    "exp.title": "Experiencia",
    "exp.job1Role": "Programador Junior",
    "exp.job1Date": "Julio 2026 - Presente",
    "exp.job1Org": "Hospital General de Granollers",
    "exp.job1b1": "Desarrollo y creación desde cero de un nuevo sistema informático integral para la gestión de personal.",
    "exp.job1b2": "Diseño de módulos para el control de horarios, turnos de trabajo, permisos y expedientes de empleados.",
    "exp.job1b3": "Integración con bases de datos y digitalización de los flujos de trabajo del departamento de RRHH.",
    "exp.job1b4": "Análisis de requisitos y soporte continuo a los usuarios de la plataforma.",
    "exp.job2Role": "Prácticas de desarrollo · CFGS DAM",
    "exp.job2Date": "Octubre 2025 - Mayo 2026 · 515 h",
    "exp.job2Org": "Iswolk Technology — Consultoría informática (convenio Tecnocampus)",
    "exp.job2b1": "Desarrollo e integración de APIs.",
    "exp.job2b2": "Gestión y administración de cursos y plataformas.",
    "exp.job2b3": "Atención y seguimiento de clientes en un entorno profesional real.",
    "exp.job3Role": "Prácticas de sistemas y redes · CFGM SMX",
    "exp.job3Date": "Junio 2023 - Marzo 2024 · 400 h",
    "exp.job3Org": "Escola Universitària d'Hoteleria i Turisme — Gran Sol",
    "exp.job3b1": "Mantenimiento y configuración de sistemas y equipos informáticos.",
    "exp.job3b2": "Configuración y administración de redes.",
    "exp.job3b3": "Resolución de incidencias técnicas y soporte al usuario.",
    "exp.job3b4": "Trabajo en equipo en un entorno laboral real.",
    "edu.title": "Estudios",
    "edu.badgeUni": "Grado universitario",
    "edu.badgeHigher": "Grado superior",
    "edu.badgeMid": "Grado medio",
    "edu.deg0": "Grado en Ingeniería Informática de Gestión y Sistemas de Información",
    "edu.deg0Date": "Septiembre 2026 - Presente",
    "edu.deg1": "CFGS Desarrollo de Aplicaciones Multiplataforma",
    "edu.deg1Date": "Septiembre 2024 - Junio 2026",
    "edu.deg2": "CFGM Sistemas Microinformáticos y Redes",
    "edu.deg2Date": "Septiembre 2022 - Junio 2024",
    "skills.title": "Habilidades",
    "skills.hardTitle": "Habilidades técnicas",
    "skills.softTitle": "Habilidades personales",
    "projects.title": "Proyectos",
    "projects.sub": "Proyectos públicos de mi perfil de GitHub.",
    "projects.loading": "Cargando proyectos…",
    "projects.viewAll": "Ver todo en GitHub",
    "projects.empty": "Pronto habrá proyectos públicos aquí.",
  ...
  en: {
    ...
    "nav.contact": "Contact",
    "hero.eyebrow": "Cross-platform application developer",
    "hero.lead": "I build applications and web solutions with clean code, attention to detail and a constant drive to learn.",
    "hero.ctaProjects": "View projects",
    "hero.ctaContact": "Get in touch",
    "hero.statHours": "internship hours",
    "hero.statDegrees": "degrees & studies",
    ...
    "about.levelNative": "Native",
    "about.levelInter": "Intermediate",
    "exp.title": "Experience",
    "exp.job1Role": "Junior Developer",
    "exp.job1Date": "July 2026 - Present",
    "exp.job1Org": "Hospital General de Granollers",
    "exp.job1b1": "End-to-end development of a new comprehensive IT system for staff management.",
    "exp.job1b2": "Design of modules for shift scheduling, time tracking, leave requests, and employee records.",
    "exp.job1b3": "Database integration and digitization of HR department internal workflows.",
    "exp.job1b4": "Requirements gathering and ongoing support for platform end users.",
    "exp.job2Role": "Development internship · CFGS DAM",
    "exp.job2Date": "October 2025 - May 2026 · 515 h",
    "exp.job2Org": "Iswolk Technology — IT consultancy (Tecnocampus partnership)",
    "exp.job2b1": "Development and integration of APIs.",
    "exp.job2b2": "Management and administration of courses and platforms.",
    "exp.job2b3": "Client support and follow-up in a real professional environment.",
    "exp.job3Role": "Systems and networks internship · CFGM SMX",
    "exp.job3Date": "June 2023 - March 2024 · 400 h",
    "exp.job3Org": "University School of Hospitality and Tourism — Gran Sol",
    "exp.job3b1": "Maintenance and configuration of IT systems and equipment.",
    "exp.job3b2": "Network configuration and administration.",
    "exp.job3b3": "Resolution of technical incidents and user support.",
    "exp.job3b4": "Teamwork in a real working environment.",
    "edu.title": "Education",
    "edu.badgeUni": "Bachelor's Degree",
    "edu.badgeHigher": "Higher degree",
    "edu.badgeMid": "Intermediate degree",
    "edu.deg0": "Bachelor's Degree in Computer Engineering & Information Systems",
    "edu.deg0Date": "September 2026 - Present",
    "edu.deg1": "Higher Diploma in Cross-platform Application Development",
    "edu.deg1Date": "September 2024 - June 2026",
    "edu.deg2": "Intermediate Diploma in Microcomputer Systems and Networks",
    "edu.deg2Date": "September 2022 - June 2024",
    "skills.title": "Skills",
    "skills.hardTitle": "Technical skills",
    "skills.softTitle": "Personal skills",
    "projects.title": "Projects",
    "projects.sub": "Public projects from my GitHub profile.",
    "projects.loading": "Loading projects…",
    "projects.viewAll": "View all on GitHub",
    "projects.empty": "Public projects will appear here soon.",
...
function repoCard(r) {
  return `
    <a class="proj-card card-glow" href="${r.html_url}" target="_blank" rel="noopener">
      ...
      <div class="proj-meta">
        ${r.language ? `<span class="lang"><i></i>${escapeHtml(r.language)}</span>` : ""}
...
function renderProjects() {
  ...
  if (!grid) return;
  if (loadedRepos === null) {
    grid.innerHTML = featuredCard();
    return;
  }
  if (loadedRepos === "error") {
    grid.innerHTML = featuredCard() + `<div class="projects-loading">${translations[currentLang]["projects.error"]}</div>`;
    return;
  }
  grid.innerHTML = featuredCard() + loadedRepos.map(repoCard).join("");
}
...
async function loadProjects() {
  ...
  try {
    ...
    loadedRepos = repos
      .filter(r => !r.fork && r.name.toLowerCase() !== portfolioRepo)
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  applyLang(savedLang || (translations[browserLang] ? browserLang : "ca"));
  loadProjects();
});
